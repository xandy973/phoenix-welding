...
export declare class EdgeFunctionsRegistry {
    ...
    private projectDir;
    private command;
    constructor({ aiGatewayContext, bundler, command, config, configPath, directories, env, featureFlags, getUpdatedConfig, importMapFromTOML, projectDir, runIsolate, servePath, }: EdgeFunctionsRegistryOptions);
