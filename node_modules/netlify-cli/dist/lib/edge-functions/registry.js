...
export class EdgeFunctionsRegistry {
    ...
    projectDir;
    command;
    constructor({ aiGatewayContext, bundler, command, config, configPath, directories, env, featureFlags, getUpdatedConfig, importMapFromTOML, projectDir, runIsolate, servePath, }) {
