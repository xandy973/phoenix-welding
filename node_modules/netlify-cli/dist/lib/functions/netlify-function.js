...
export default class NetlifyFunction {
    ...
    srcFiles = new Set();
    constructor({ aiGatewayContext, blobsContext, config, directory, displayName, mainFile, name, projectRoot, runtime, settings, srcPath, timeoutBackground, timeoutSynchronous, }) {
