...
import { chalk, log, getTerminalLink, NETLIFYDEVERR, NETLIFYDEVLOG, NETLIFYDEVWARN, warn, } from '../../utils/command-helpers.js';
...
export class FunctionsRegistry {
    ...
    settings;
    timeouts;
    constructor({ aiGatewayContext, blobsContext, capabilities, config, debug = false, frameworksAPIPaths, generatedFunctions, isConnected = false, logLambdaCompat, manifest, projectRoot, settings, timeouts, }) {
